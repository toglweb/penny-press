      ...
      <DialogContent className="bg-white rounded-lg max-w-md w-full mx-4 animate-fade-in p-0">
        <div className="p-6">
          ...
          <div className="mb-6">
            <Button
              variant="outline"
              className="w-full py-3 px-4 border text-xl border-gray-300 rounded-lg flex items-center justify-center font-medium hover:bg-[#F2F2F2] transition mb-4"
            >Credit Card
            </Button>
            <Button
              variant="outline"
            ...
            <Button
              ...
              className="w-full py-3 px-4 border text-xl border-gray-300 rounded-lg flex items-center justify-center font-medium hover:bg-[#F2F2F2] transition mb-4"
            >
              Pay with <i className="fab fa-google"></i>pay
            </Button>

            <Button
              onClick={handleRequestFunds}
              variant="outline"
              className="w-full py-3 flex flex-col px-4 border border-gray-300 rounded-lg font-medium hover:bg-[#F2F2F2] transition mb-3 h-[75px]"
            >
              <div className="flex items-center justify-center text-xl">
                Pay with <img src={profileImg} alt="Profile" width="32" className="mx-1" /> Togl pay
              </div>
